...
class list
{
    ...
    list<T>         *succ;                          // Bardzo brzydkie rozwiązanie
    list<T>         *exit;
    ...
    public:
        ...
        struct iterator
        {
            ...
            public:
                ...
                iterator(key *pp,list<T> *MM) : ptr(pp),M(MM) {}
        ...
        void reject(iterator i)
        {
            ...
            if(p->next)
                ...
                en=p->prev;
            //delete p;             Tylko usuwamy, nie kasujemy!
